...
function HomePage({ home, fetchHome, featureProduct, fetchFeatureProducts }) {
  ...
  return home.loading ? (
    ...
    <div>
      ...
      <div class="container mx-auto px-40">
        <div class="grid grid-cols-4 gap-4">
          <div class="col-span-1 ">
            <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-20 bg-green-50 rounded-lg">
              <Link to="/about">
          ...
          <div class="col-span-1">
            <div class="bg-white  mx-auto shadow-lg rounded-lg hover:shadow-xl transition duration-200 max-w-sm my-20 ">
              {home &&
        ...
        {home &&
          home.homeData && <div>
            <div className="text-left uppercase text-lg text-green-800 border-b-2 border-green-700"> Shop By Category</div>
      ...
      <div class="bg-light-blue-300 pt-20">
        <img class="object-fill h-full w-full " src={certificate_banner} />
      </div>
    </div>
  )
}
